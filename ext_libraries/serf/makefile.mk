...
CONFOSLL=$(OPENSSL_CFLAGS)
.ELSE
OPENSSLINCDIR=external
CONFOSLL=$(SOLARINCDIR)$/$(OPENSSLINCDIR)
.ENDIF
.ENDIF
...
BUILD_ACTION=scons $(CONFIGURE_SCONS) APR=$(SOLARVERSION)/$(INPATH) APU=$(SOLARVERSION)/$(INPATH) OPENSSL=$(CONFOSLL)
