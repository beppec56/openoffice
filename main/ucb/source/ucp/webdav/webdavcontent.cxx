    ...
    throw( uno::Exception )
{
    ...
    try
    {
        ...
        //It sould tell a user who is holding the document lock.
        ...
        //TODO i126305 to discuss:
        //on some webdav server, the 180 time formerly used appears too log,
        //in this case, the response to a lock refresh operation we receive an error
        //as 'Connection reset by peer', meaning the session was timeouted by the other end
        //so, for now drop the defaul time to 120 seconds, seems better
        // in the future, some 'ping' of the open connection session should be added
        ucb::Lock aLock(
            ucb::LockScope_EXCLUSIVE,
            ucb::LockType_WRITE,
            ucb::LockDepth_ZERO,
