...
SfxMedium::GetAuthenticationInteractionHandler()
{
    ...
    if ( xFactory.is() )
    {
        pImp->xCredentialInteraction = ::com::sun::star::uno::Reference< com::sun::star::task::XInteractionHandler >( xFactory->createInstance( DEFINE_CONST_UNICODE("com.sun.star.task.InteractionHandler") ), ::com::sun::star::uno::UNO_QUERY );
        return pImp->xCredentialInteraction;
    }
