...
#ifndef __DEBUGLOGRING_HXX_
#define __DEBUGLOGRING_HXX_
...
class ODebugLogRing : public ::cppu::WeakImplHelper3< ::com::sun::star::logging::XDebugLogRing,
...
public:
    ODebugLogRing( const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XComponentContext >& xContext );
...
// XDebugLogRing
    ...
    virtual void SAL_CALL flushLog( const ::rtl::OUString& aFileName ) throw (::com::sun::star::uno::RuntimeException);
